...
var app = (function () {
    ...
    class Testing extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance, create_fragment, safe_not_equal, { firstName: 0, lastName: 1 });
    	}
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			claim_component(testing.$$.fragment, main_nodes);
    		...
    		m(target, anchor) {
    			...
    			mount_component(testing, main, null);
    			current = true;
    		},
    		p: noop,
    		i(local) {
